# Old finsihed Roadmap tasks

The file ROADMAP.md contains the latest parts this file is for historical audit and once in a while finished things from ROADMAP.med are moved here in order to reduce the size of ROADMAP.md
