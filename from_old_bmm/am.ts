...
export class ARCHETYPE_TERM extends Any {
    ...
    constructor(code: String, text: String, description: String, other_items?: Map<string, String>) {
        super();
        this.code = code;
        this.text = text;
...
export abstract class C_DEFINED_OBJECT extends C_OBJECT {
    ...
    constructor(
        ...
        super(rm_type_name, node_id, occurrences, is_deprecated, sibling_order, parent, soc_parent);
...
export class C_COMPLEX_OBJECT extends C_DEFINED_OBJECT {
    ...
    constructor(
        ...
        super(rm_type_name, node_id, occurrences, is_deprecated, sibling_order, parent, soc_parent, default_value);
