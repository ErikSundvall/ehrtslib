...
type BMM_OPERATOR_POSITION = any;
type undefined = any;
...
type undefined = any;
type BMM_ROUTINE_DEFINITION = any;
...
type BMM_PARAMETER_DIRECTION = any;
...
type undefined = any;
type BMM_PACKAGE_CONTAINER = any;
...
type BMM_WRITABLE_VARIABLE = any;
...
type BMM_READONLY_VARIABLE = any;
...
type BMM_ACTION_DECISION_TABLE = any;
...
type EL_BOOLEAN_EXPRESSION = any;
...
type undefined = any;
type P_BMM_CONTAINER_TYPE = any;
type BMM_CONTAINER_PROPERTY = any;
...
type P_BMM_SIMPLE_TYPE = any;
type BMM_UNITARY_PROPERTY = any;
...
type P_BMM_INDEXED_CONTAINER_TYPE = any;
type BMM_INDEXED_CONTAINER_PROPERTY = any;
