 ...
 * @example
 * ```typescript
 * import { JsonCanonicalSerializer, JsonCanonicalDeserializer } from './serialization/json/mod.ts';
 * 
 ...
 * @example
 * ```typescript
 * import { JsonConfigurableSerializer, JsonConfigurableDeserializer } from './serialization/json/mod.ts';
 * 
