...
```typescript
import { XmlSerializer } from "./serialization/xml/mod.ts";
...
```typescript
import { XmlSerializer, TypeRegistry } from "./serialization/xml/mod.ts";
import { CODE_PHRASE, TERMINOLOGY_ID } from "./openehr_rm.ts";
...
```typescript
import { XmlDeserializer } from "./serialization/xml/mod.ts";
...
```typescript
import { XmlSerializer, XmlDeserializer, TypeRegistry } from "./serialization/xml/mod.ts";
import { CODE_PHRASE, TERMINOLOGY_ID } from "./openehr_rm.ts";
...
```typescript
import { TypeRegistry } from "./serialization/xml/mod.ts";
import * as rm from "./openehr_rm.ts";
...
```bash
deno test --allow-read test_data/tests/enhanced/xml_serializer.test.ts
deno test --allow-read test_data/tests/enhanced/xml_deserializer.test.ts
deno test --allow-read test_data/tests/enhanced/serialization_common.test.ts
```
