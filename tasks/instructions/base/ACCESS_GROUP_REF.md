...
The `ACCESS_GROUP_REF` class is a specialized OBJECT_REF for referencing access
control groups.
...
ACCESS_GROUP_REF is used in security and access control contexts to reference
