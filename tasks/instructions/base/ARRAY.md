...
The `Array<T>` class represents a fixed-size ordered collection of items with indexed access. Unlike `List`, an array has a predetermined size set at creation.

-   **Reference:** [openEHR BASE - Array](https://specifications.openehr.org/releases/BASE/latest/foundation_types.html#_array_class)
