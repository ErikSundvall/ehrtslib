...
The `Boolean` class is an openEHR wrapper around the primitive boolean type. It provides value and reference equality semantics consistent with the openEHR model.

-   **Reference:** [openEHR BASE - Foundation Types - Boolean](https://specifications.openehr.org/releases/BASE/latest/foundation_types.html#_boolean_class)
