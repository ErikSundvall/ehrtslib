...
The `Character` class represents a single character. It extends `Ordered` to
provide comparison capabilities.

- **Reference:**
  [openEHR BASE - Foundation Types - Character](https://specifications.openehr.org/releases/BASE/latest/foundation_types.html#_character_class)
