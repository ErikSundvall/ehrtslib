...
The `Cardinality` class specifies cardinality constraints (multiplicity + uniqueness) for container attributes.

-   **Reference:** [openEHR BASE - Cardinality](https://specifications.openehr.org/releases/BASE/latest/foundation_types.html#_cardinality_class)
