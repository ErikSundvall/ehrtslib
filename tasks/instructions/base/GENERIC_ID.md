...
The `GENERIC_ID` class represents a generic identifier for identifiers whose
format is otherwise unknown to openEHR. It includes a scheme attribute to name
the identification system.

- **Reference:**
  [openEHR BASE - GENERIC_ID](https://specifications.openehr.org/releases/BASE/latest/base_types.html#_generic_id_class)
