...
The `Integer` class is an openEHR wrapper around primitive integer values. It extends `Ordered_Numeric` to provide comparison and arithmetic operations.

-   **Reference:** [openEHR BASE - Foundation Types - Integer](https://specifications.openehr.org/releases/BASE/latest/foundation_types.html#_integer_class)
