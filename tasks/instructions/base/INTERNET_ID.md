...
The `INTERNET_ID` class represents identifiers in the form of reverse internet
domain names.

- **Format:** Reverse domain name (e.g., `"org.openehr"`,
  `"com.hospital.department"`)
...
The reverse domain name format ensures global uniqueness without central
registry.
