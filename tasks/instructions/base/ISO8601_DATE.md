...
The `Iso8601_date` class represents dates in ISO 8601 format. It supports partial dates (year only, year-month, or full date).

-   **Format:** `YYYY[-MM[-DD]]`
-   **Examples:** `"2024"`, `"2024-03"`, `"2024-03-15"`
-   **Reference:** [openEHR BASE - Iso8601_date](https://specifications.openehr.org/releases/BASE/latest/foundation_types.html#_iso8601_date_class)
