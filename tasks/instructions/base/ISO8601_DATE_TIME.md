...
The `Iso8601_date_time` class represents combined date and time in ISO 8601
format.

- **Format:** `YYYY-MM-DD'T'hh:mm:ss[.sss][Z|±hh:mm]`
- **Examples:** `"2024-03-15T14:30:45"`, `"2024-03-15T14:30:45.123Z"`,
...
- **`to_unix_timestamp(): Integer`** - Convert to Unix timestamp (seconds since
