...
The `Multiplicity_interval` class represents intervals of integers used to specify multiplicities in UML-like constraints (e.g., 0..1, 1..*, 0..*).

-   **Reference:** [openEHR BASE - Multiplicity_interval](https://specifications.openehr.org/releases/BASE/latest/foundation_types.html#_multiplicity_interval_class)

## 2. Behavior

Multiplicity_interval extends Proper_interval<Integer> with special semantics for unbounded upper limits (* in UML).
