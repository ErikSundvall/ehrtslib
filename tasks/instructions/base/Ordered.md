...
The `Ordered` class is an abstract ancestor for types with total ordering (comparison operations).

-   **Reference:** [openEHR BASE - Ordered](https://specifications.openehr.org/releases/BASE/latest/foundation_types.html#_ordered_class)
