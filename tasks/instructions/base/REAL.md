...
The `Real` class is an openEHR wrapper around floating-point numbers. It extends `Ordered_Numeric` to provide comparison and arithmetic operations with decimal precision.

-   **Reference:** [openEHR BASE - Foundation Types - Real](https://specifications.openehr.org/releases/BASE/latest/foundation_types.html#_real_class)
