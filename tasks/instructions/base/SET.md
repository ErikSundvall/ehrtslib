...
The `Set<T>` class represents an unordered collection of items where duplicates
are not allowed. It extends `Container<T>` and enforces uniqueness of elements.

- **Reference:**
  [openEHR BASE - Set](https://specifications.openehr.org/releases/BASE/latest/foundation_types.html#_set_class)
