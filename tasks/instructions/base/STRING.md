...
The `String` class is an openEHR wrapper around the primitive string type. It
extends `Ordered` to provide comparison operations and implements string
manipulation methods.

- **Reference:**
  [openEHR BASE - Foundation Types - String](https://specifications.openehr.org/releases/BASE/latest/foundation_types.html#_string_class)

## 2. Behavior

### 2.1. Constructor and Factory Methods

- **Purpose:** Create String instances from primitive strings or other String
  objects.
- **Pseudo-code:**
  ```typescript
  constructor() {
...
- String operations return new String objects and don't modify the original
  (immutability).
