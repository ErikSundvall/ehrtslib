...
The `TERMINOLOGY_ID` class represents an identifier for a terminology or coding system.

-   **Format:** `name[([version])]`
-   **Examples:** `"SNOMED-CT"`, `"ICD-10"`, `"LOINC(2.71)"`, `"local"`
-   **Reference:** [openEHR BASE - TERMINOLOGY_ID](https://specifications.openehr.org/releases/BASE/latest/base_types.html#_terminology_id_class)
