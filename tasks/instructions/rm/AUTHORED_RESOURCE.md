...
**See:** `tasks/instructions/base/AUTHORED_RESOURCE.md` for detailed documentation.
...
```typescript
// See tasks/instructions/base/AUTHORED_RESOURCE.md for detailed examples
import { AUTHORED_RESOURCE } from "./openehr_base.ts";

const resource = new AUTHORED_RESOURCE();
// ... refer to BASE package documentation
```

## References

- See `tasks/instructions/base/AUTHORED_RESOURCE.md` for complete documentation
