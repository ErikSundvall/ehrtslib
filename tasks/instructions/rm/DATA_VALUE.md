...
The `DATA_VALUE` class is the abstract parent for all data value types in openEHR. It represents actual clinical or administrative data values.

-   **Reference:** [openEHR RM - DATA_VALUE](https://specifications.openehr.org/releases/RM/latest/data_types.html#_data_value_class)

## 2. Behavior

### 2.1. Abstract Class

DATA_VALUE is abstract and cannot be instantiated directly. All clinical data must use concrete subtypes:
...
const coded: DATA_VALUE = DV_CODED_TEXT.from("Male", CODE_PHRASE.from("at0001", "local"));
```
