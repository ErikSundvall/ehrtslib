...
The `DV_QUANTITY` class represents a quantified value with magnitude and units.
It is used for measurements like blood pressure, weight, temperature, etc.
...
- **`is_strictly_comparable_to(other: DV_QUANTITY): Boolean`** - Check unit
  compatibility
