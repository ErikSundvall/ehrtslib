...
- **Reference:**
  [openEHR RM - INTERVAL_EVENT](https://specifications.openehr.org/releases/RM/latest/data_structures.html#_interval_event_class)
...
event.math_function = DV_CODED_TEXT.from(
  "mean",
  CODE_PHRASE.from("146", "openehr"),
);
```
