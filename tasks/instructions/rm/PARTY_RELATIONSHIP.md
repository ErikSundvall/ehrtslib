...
- **Reference:**
  [openEHR RM - PARTY_RELATIONSHIP](https://specifications.openehr.org/releases/RM/latest/demographic.html#_party_relationship_class)

## 2. Behavior

### 2.1. Properties

- `type: DV_CODED_TEXT` - Type of relationship (employment, membership, kinship,
  etc.)
...
relationship.type = new DV_CODED_TEXT(
  "employment",
  "openehr::relationship_type",
);
