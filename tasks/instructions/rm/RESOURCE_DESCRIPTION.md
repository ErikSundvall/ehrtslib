...
**See:** `tasks/instructions/base/RESOURCE_DESCRIPTION.md` for detailed documentation.
...
- See `tasks/instructions/base/RESOURCE_DESCRIPTION.md` for complete documentation
