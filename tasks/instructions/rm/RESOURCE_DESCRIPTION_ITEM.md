...
**See:** `tasks/instructions/base/RESOURCE_DESCRIPTION_ITEM.md` for detailed documentation.
...
```typescript
// See tasks/instructions/base/RESOURCE_DESCRIPTION_ITEM.md for detailed examples
import { RESOURCE_DESCRIPTION_ITEM } from "./openehr_base.ts";

const resource = new RESOURCE_DESCRIPTION_ITEM();
// ... refer to BASE package documentation
```

## References

- See `tasks/instructions/base/RESOURCE_DESCRIPTION_ITEM.md` for complete documentation
